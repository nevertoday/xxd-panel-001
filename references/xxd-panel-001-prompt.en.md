...
This is not a second aesthetic prompt. Read and use `references/001-source.md` in full and verbatim before generation; it is the sole creative and aesthetic authority for Panel 001. This file only appends the current user's runtime variables.
...
```text
complete verbatim 001-source.md
