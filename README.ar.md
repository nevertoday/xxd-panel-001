...
يحتفظ المستودع بمجلد [`assets/examples/`](assets/examples/) للأعمال القادمة. لن يُضاف إلا عمل مكتمل بأسلوب 001 ومؤكد من صاحب المشروع؛ ولن تُستخدم منشورات أو صور من أساليب أخرى كعناصر مؤقتة.

ستعرض النماذج القادمة قدرة 001 على التكيف فقط، ولن تصبح موضوعاتها أو استعاراتها أو ألوانها أو نصوصها أو نسبها مراجع للتوليد أو قيماً افتراضية.
...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى ورسم 001 التحريري اليدوي القديم في الأسفل؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار ورسم 001 التحريري اليدوي القديم في اليمين؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `001.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
